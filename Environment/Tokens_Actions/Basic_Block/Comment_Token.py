...
class Comment_Token(Token):
    ...
    comment_type_category = {
        0: Comment_Category.Full_Comment,
        1: Comment_Category.Full_Comment,
        2: Comment_Category.Open_Range_Comment,
        3: Comment_Category.Close_Range_Comment,
    }
    ...
    def parse(s: str):
        ...
        type = list(Comment_Token.comment_type_mapping.keys())[
            list(Comment_Token.comment_type_mapping.values()).index(s)
        ]
