...
statement_list = [
    [
        KeywordRepresentation_Token("SELECT"),
        Whitespace_Token(0),
        StringRepresentation_Token("table_name"),
        Whitespace_Token(0),
        KeywordRepresentation_Token("FROM"),
        Whitespace_Token(0),
        StringRepresentation_Token("information_schema.tables"),
    ],
]
