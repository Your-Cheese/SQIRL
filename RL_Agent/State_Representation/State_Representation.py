...
class State_Representation:
    ...
    def __init__(self, db_type) -> None:
        ...
        self.sql_representation = SQL_Representation(
            db_type,
            self.sql_input_size,
            self.sql_output_size,
            self.hidden_size,
            self.sql_max_length,
        )
        self.payload_representation = Payload_Representation(
            self.payload_input_size,
            self.payload_output_size,
            self.hidden_size,
